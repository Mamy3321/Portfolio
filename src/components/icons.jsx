...
export function FacebookIcon({ size = 20, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M13.5 22v-8.4h2.82l.42-3.28H13.5V8.2c0-.95.26-1.6 1.63-1.6h1.74V3.7C16.55 3.65 15.54 3.56 14.36 3.56c-2.46 0-4.15 1.5-4.15 4.26v2.5H7.38v3.28h2.83V22h3.29Z" />
    </svg>
  )
}
